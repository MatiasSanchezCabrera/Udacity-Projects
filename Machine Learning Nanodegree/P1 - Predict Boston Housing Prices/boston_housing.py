...
def explore_city_data(city_data):
    ...
    # Used to create a Histogram for the prices ranges
    price_distribution_graph(city_data)

def price_distribution_graph(city_data):
    """Used to create a Histogram for the prices ranges in this Dataset."""

    pl.figure()
    pl.title('Price distribution')
    pl.hist(city_data.target)
    pl.legend()
    pl.xlabel('Price Interval')
    pl.ylabel('# of Houses')
    pl.show()
